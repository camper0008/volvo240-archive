...
async function main() {
    ...
    app.get("/", (req, res) => {
        ...
        res.send('<h1>Volvo240.dk</h1><hr><p><a href="/default.asp">Link til forsiden</a></p><p><a href="/arkiv/">Link til forum indlæg</a></p><hr><p>Her er en liste af alle ikke-forum filer fundet:</p> ' + list.join("<br>"));
    })
    app.get("/*", (req, res) => {
