...
<HEAD>
    ...
    <META NAME="Title" CONTENT="Volvo 200-serien">
    <META NAME="Keywords" CONTENT="Volvo, Volvo 200, Volvo 240, Volvo 242, Volvo 244, Volvo 245, Volvo 260, Volvo 262, Volvo 264, Volvo 265">
    ...
    <META name="verify-v1" content="4SPQKBlJyoo/0LayYo/2inNIwBOjdBJQcdTO9treOkc=" />
    ...
    <link rel="stylesheet" type="text/css" href="/common/volvo.css">
    <LINK REL="SHORTCUT ICON" HREF="http://www.volvo240.dk/favicon.ico" type="image/x-icon">
...
;} else {
document.write('<' + 'script language="javascript" type="text/javascript" src="' + rjsPath + 'iemain.js"><\/script\>');
...
<table width="1000" border="0" cellspacing="0" align="center">
  <thead>
  <tr>
    <td width="315" height="23" align="center"><font color="#c8c8c8" size="1">volvo 240</font></td>
    <td height="23" align="center"><font color="#c8c8c8" size="1">volvo 200 Serien</font></td>
    <td width="315" height="23" align="center"><font color="#c8c8c8" size="1">volvo 244</font></td>
  </tr>
  <tr>
    <td width="315" align="left" valign="bottom">
      <img border="0" src="/images/volvo240dksgray.gif" width="132" height="40" alt="Logo">
    </td>
    <td align="center" valign="bottom"><b><font face="tahoma" color="#FFFFFF" size="5"></font></b></td>
...
<table border="0" width="1000" id="default0" align="center">
  <tr>
    <td>

      <table border="0" width="998" id="default1" align="center">
        <tr>
...
<!--*****************************-->
            ...
            <table border='1' width='100%' cellpadding='0' cellspacing='0' id='defaultNews'>
            <thead>
              <tr>
                <td colspan='2'><b>Sidste Nyt</b></td>
              </tr>
              <tr>
                <td>Dato</td><td>Overskrift</td>
              </tr>
            </thead>
            <tbody>
...
<!--*****************************-->
            ...
            <thead>
              <tr>
                <td colspan='2'><b>Site Nyt (Hold musen over linket)</b></td>
              </tr>
              <tr>
                <td>Dato</td><td>Side</td>
              </tr>
            </thead>
            <tbody>
...
<!--*****************************-->
            ...
            <table border='1' width='100%' cellpadding='0' cellspacing='0' id='defaultTips'>
            <thead>
              <tr>
                <td colspan='2'><b>Seneste Tips & Tricks</b></td>
              </tr>
              <tr>
                <td>Dato</td><td>Overskrift</td>
              </tr>
...
<!--*****************************-->
            ...
            <tbody>
<tr><td colspan='2'>Der er ingen biler til salg i databasen.</td></tr>
            </tbody>
            </table>
          </td>
        </tr>
...
<!-- ###########  center ############### -->
      ...
      <table align="center" border="0" width="1000" height="200" id="default2">
        <tr>
...
<!--*****************************-->
            ...
            <table border="1" width="100%" cellpadding="0" cellspacing="0" id="defaultVote">
            <thead>
              <tr>
                <td colspan="3" width="220" align="center"><b>Afstemning</b></td>
              </tr>
            </thead>
            <tbody>
<tr><td colspan='3'><b>Har du en smartphone?</b></td></tr><tr><td colspan='3'><form method='POST' action='/default.asp?fV=70'><input type='hidden' name='Voteid' value=70><input type='radio' value='Ja' name='R1'>Ja<br><input type='radio' value='Nej' name='R1'>Nej<br><input type='radio' value='Ved ikke' name='R1'>Ved ikke<br><input type='submit' value='Stem' name='B1'></form></td></tr>
            </tbody>
            </table>
          </td>
          <td valign="top">
...
<hr width="1000" align="center">
<table width="1000" border="0" cellspacing="0" cellpadding="0" bgcolor="#C0C0C0" align="center">
<thead>
  <tr>
